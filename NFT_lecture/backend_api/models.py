...
class Token(models.Model):
    Token_id = models.ForeignKey("User", related_name="User", on_delete=models.CASCADE, db_column="Token_id")
    tokenName = models.CharField(max_length=20, blank=False, null=False)
    tokenaddress = models.CharField(max_length=35, blank=False, null=False)
    def __str__(self):
