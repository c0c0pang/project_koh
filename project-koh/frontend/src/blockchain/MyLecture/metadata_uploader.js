...
export const Uploader = async (nftName,description,hiddenImgUrl,privateKey) =>{
    try {
        ...
        await SendJsonFileToIPFS(jsonFile,privateKey);
...
export const Uploader_Apply =async (nftName,hiddenImgUrl,count,privateKey) =>{
    try {
        ...
        console.log(jsonFile)
        await SendJsonApplyFileToIPFS(jsonFile,privateKey);
        console.log("complete!");
    } catch (error) {
        console.log(error);
    }
